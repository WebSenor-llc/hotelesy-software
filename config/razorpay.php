...
return [
    ...
    'mandate_amount_paise' => (int) env('RAZORPAY_MANDATE_AMOUNT', 100),

    // Default monthly retail price for the Growth plan (in paise).
    'default_monthly_paise' => (int) env('RAZORPAY_MONTHLY_PRICE', 99900),

    // Currency
    'currency' => 'INR',

    // After this many days the trial converts to paid.
    'trial_days' => (int) env('RAZORPAY_TRIAL_DAYS', 30),
    ...
    'test_mode' => (bool) env('RAZORPAY_TEST_MODE', true),
];
